...
import top.jplayer.audio.dialog.ForgetDialogFragment;
import top.jplayer.audio.dialog.RegisterDialogFragment;
    ...
    private void initEvent() {
        ...
        mBtnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LoginDaoUtil loginDaoUtil = new LoginDaoUtil(mContext);
                ...
                if (realBean != null) {
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            rxDialogShapeLoading.dismiss();
                            Toast.makeText(mContext, "账号不存在，或密码不正确", Toast.LENGTH_SHORT).show();
                        }
                    }, delayMillis);
                }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.forget_password:
                new ForgetDialogFragment().show(getSupportFragmentManager(), "forget");
                break;
