...
public class DateUtils {
    ...
    public static String getCurrentBigMonth(String data) {
    ...
    /**
     * 返回当前日期的 格式为： FORMAT_HH_MM_SS
     *
     * @return
     */
    public static String getCurrentTime() {
        Date now = new Date();
        return getDateFormat(FORMAT_HH_MM_SS).format(now);
    }
    ...
    public static Date getDateByTimeMilliSecond(String date) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat(FORMAT_YYYY_MM_DD_HH_MI_SS_SSS, Locale.CHINA);
